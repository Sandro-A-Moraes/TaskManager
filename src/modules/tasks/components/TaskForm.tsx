...
const TaskForm = () => {
  ...
  const handleDescricaoChange = (e: ChangeEvent<HTMLTextAreaElement>) =>
    dispatch({ field: "descricao", value: e.target.value });

  const handlePrioridadeChange = (value: Priority) =>
    dispatch({ field: "prioridade", value });
      ...
      <div className="border border-gray-200 rounded-xl shadow">
        ...
        <form className="p-6 flex flex-col gap-4" onSubmit={handleSubmit}>
          <div>
            ...
            <input
              type="text"
              className="w-full border my-3 border-gray-200 p-3 rounded-xl"
          ...
          <div>
            ...
            <textarea
              className="w-full border my-3 min-h-30 resize-none border-gray-200 p-3 rounded-xl"
              placeholder="Ex: Revisar documentação do projeto"
              value={descricao}
          ...
          <div>
            ...
            <select
              className="w-full border cursor-pointer my-3 appearance-none resize-none border-gray-200 p-3 rounded-xl"
              value={status}
          ...
          <div>
            ...
            <select
              ...
              value={prioridade}
              onChange={(e) =>
                handlePrioridadeChange(e.target.value as Priority)
              }
            >
          ...
          <div className="flex justify-between gap-3">
            <button
              className="flex items-center gap-2 bg-bg-purple-primary active:bg-purple-900 w-full rounded-lg p-4 text-white "
              type="submit"
            >
            ...
            <button
              type="button"
              onClick={() => navigate("/")}
              className="flex items-center gap-2 w-full bg-gray-100 p-4 rounded-lg"
            >
      ...
      <div className="bg-purple-50 p-4 my-6 flex gap-4 rounded-xl">
        ...
        <div className="font-light text-purple-950">
          ...
          <p className="text-purple-800 font-normal">
            Seja específico no título e detalhado na descrição para facilitar o
