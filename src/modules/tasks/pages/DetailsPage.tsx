  ...
  return (
    <div className='p-6'>
      ...
      <div className='flex flex-col mt-6 rounded-2xl shadow-xl'>
        <TaskDetailsHeader title={titulo} createdAt={dataCriacao} priority={prioridade} />
        ...
        <div className='bg-white p-7 flex flex-col gap-6 rounded-b-2xl'>
          ...
          <div className='flex flex-col gap-4'>
            ...
            <TaskStatusSelector currentStatus={status} onChangeStatus={(newStatus) => changeStatus(id, newStatus)} />
